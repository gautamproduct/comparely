// Instamart scraper using Playwright.
// Instamart is part of Swiggy; URL pattern is /instamart, search at /instamart/search
...
export async function scrapeInstamart(
  ...
  try {
    ...
    // Pre-set location in Swiggy's cookie/storage if known to bypass address picker
    ...
    console.error("[instamart] scrape error:", err);
